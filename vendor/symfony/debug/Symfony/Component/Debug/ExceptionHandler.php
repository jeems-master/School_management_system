...
class ExceptionHandler
{
    ...
    public function getContent(FlattenException $exception)
    {
        switch ($exception->getStatusCode()) {
            case 404:
                $title = 'Desculpe mas o que você está procurando não pode ser encontrado.';
                break;
            default:
                $title = 'Talvez você tenha eito algo errado. Tente começar novamente!';
        }
...
EOF
                ...
                if ($this->debug) {
                    $title = sprintf('Exceção lançada ao manipular uma exceção (%s: %s)', get_class($exception), $exception->getMessage());
                } else {
                    $title = 'Talvez você tenha eito algo errado. Tente começar novamente!';
                }
            }
