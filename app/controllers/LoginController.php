...
class LoginController extends BaseController {
	...
	public function forgetpwdStepOne()
	{
		...
		if($ifUserExists->count() == 0){
			...
			$messageBody = "Oi, <br/><br/> Clique no link para redefinir sua senha de acesso ao sistema: <br/><br/>
			<a href='$restoreUrl'>$restoreUrl</a> <br/><br/>Felicidades,<br/> Felicidades :)";

			$SmsHandler = new MailSmsHandler();
			$SmsHandler->mail($ifUserExistsGet->email,$this->panelInit->settingsArray['siteTitle']." | Recuperar Senha",$messageBody,$ifUserExistsGet->fullName);
