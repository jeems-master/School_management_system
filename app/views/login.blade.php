...
<html>
  ...
  <body class="hold-transition login-page loginMark" style="background-image: url(./assets/img/bg.jpg);">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <a href="{{URL::to('/terms')}}"><?php echo $panelInit->language['schoolTerms']; ?></a><br/>
