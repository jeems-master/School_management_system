...
<html>
  ...
  <body class="hold-transition <?php echo $panelInit->defTheme; ?> sidebar-mini" ng-app="schoex" ng-controller="mainController">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#/" class="logo">
		  ...
		  <style>img {vertical-align: middle;width: 150px;}</style>
          <span class="logo-lg">
              <?php
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{URL::to('/dashboard/profileImage/'.$users['id'])}}" style="width:45px; height:45px;" class="img-circle" alt="{{$users['fullName']}}">
            </div>
    ...
    <!-- Main Footer -->
    <footer class="main-footer" style="position: fixed; width: 100%; bottom: 0px;">
      <strong><?php echo $panelInit->settingsArray['footer']; ?></strong> -  <a target="_BLANK" href="tel:21979899151">(21) 97989-9151<!--<?php echo $panelInit->language['schoolTerms']; ?>--></a>
    </footer>
    <modal visible="chgAcYearModalShow">
        <div>
            <select class="form-control" id="selectedAcYear" ng-model="dashboardData.selectedAcYear">
              ...
              <option ng-selected="year.id == '<?php echo $panelInit->selectAcYear; ?>'" ng-repeat="year in $root.dashboardData.academicYear" value="@{{year.id}}" ng-if="year.isDefault == '1'">@{{year.yearTitle}} - Ano atual</option>
            </select>
            <br/>
